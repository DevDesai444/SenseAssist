...
# export SENSEASSIST_ONNX_MAX_NEW_TOKENS_EXTRACT="256"
# export SENSEASSIST_ONNX_MAX_NEW_TOKENS_DUE_REPAIR="128"
# export SENSEASSIST_ONNX_MAX_NEW_TOKENS_EDIT="160"
# export SENSEASSIST_ONNX_MAX_NEW_TOKENS_SCHEDULE="384"
# export SENSEASSIST_ONNX_TEMPERATURE="0.2"
# export SENSEASSIST_ONNX_TOP_P="0.95"
# export SENSEASSIST_ONNX_SPECULATIVE_DECODING="1"
# export SENSEASSIST_ONNX_SPECULATIVE_FIRST_PASS_RATIO="0.55"
# export SENSEASSIST_ONNX_POWER_AWARE_THROTTLING="1"
# export SENSEASSIST_ONNX_LOW_POWER_TOKEN_SCALE="0.65"
# export SENSEASSIST_ONNX_LOW_POWER_MIN_INTERVAL_MS="80"
# export SENSEASSIST_ONNX_DAEMON_BATCH_WINDOW_MS="8"
# export SENSEASSIST_ONNX_DAEMON_MAX_BATCH_SIZE="4"
EOF
